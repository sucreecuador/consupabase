...
function buscar(tipo, criterio) {
    ...
    if (tipo === 'productos') {
        ...
        if (criterio === 'codigo') valorBusqueda = document.getElementById('filtroCodigoContacto').value;
    }
    cargarDatos(tipo);
}
...
function mostrarTodos(tipo) {
    ...
    if (tipo === 'productos') {
        ...
        document.getElementById('filtroCodigoContacto').value = '';
    }
    cargarDatos(tipo);
}
...
function renderizarContactos(result) {
    ...
    if (contVistaActual === 1) {
        columnas = ['codigo_cliente', 'categoria', 'nombre', 'razon_social', 'ruc', 'telefono'];
    } else {
        columnas = ['codigo_cliente', 'nombre', 'direccion', 'correo', 'ruc', 'telefono'];
    }
