// facturacion.js COMPLETO - ERP SUCRE PRO
...
let detalle = [];
let ivaPorc = 15; // valor por defecto, luego se carga desde Supabase
...
async function buscarCliente() {
  ...
  if (cedula) {
    ...
    alert("Ingresa cédula o nombre para buscar.");
    return;
  }
  ...
  if (!data || data.length === 0) {
    alert("Cliente no encontrado. Puedes crearlo.");
    return;
  }
